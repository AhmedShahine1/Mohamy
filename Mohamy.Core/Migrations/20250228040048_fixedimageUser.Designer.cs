...
namespace Mohamy.Core.Migrations
{
    ...
    [Migration("20250228040048_fixedimageUser")]
    partial class fixedimageUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mohamy.Core.Entity.ConsultingData.IgnoredConsultation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("IgnoredConsultations", "dbo");
                });
            ...
            modelBuilder.Entity("Mohamy.Core.Entity.LawyerData.Profession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Mohamy.Core.Entity.ApplicationData.ApplicationUser", b =>
                {
                    b.HasOne("Mohamy.Core.Entity.Files.Images", "Profile")
                        .WithOne()
                        .HasForeignKey("Mohamy.Core.Entity.ApplicationData.ApplicationUser", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
